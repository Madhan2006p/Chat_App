        ...
        while True:
            ...
            if message:
                if self.messages:
                    ...
                    print('hi')
                    print('\r{}\r: '.format(message,self.name),end='')
...
class Client:
    ...
    def start(self):
        ...
        print('Trting to connect to {}:{}...'.format(self.host,self.port))
        ...
        print("\rReady! Leave the chatbox anytime by typing 'Quit'\n")
        print('{}: '.format(self.name),end='')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p',metavar='PORT',type=int,default=1060 , help='TCP port(sefault 1060)')
